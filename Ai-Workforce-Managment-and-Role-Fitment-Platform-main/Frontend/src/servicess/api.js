...
export const startOptimization = () => api.post("/optimization/initiate");

// Employee management
export const addEmployee = (emp) => api.post("/employees/add", emp);
export const uploadEmployeesBulk = (employees) => api.post("/employees/bulk", { employees });
